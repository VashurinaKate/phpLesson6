            ...
            <div class="cart__items">
                ...
                <div class="cart__item">
                    <div class="cart__body">
                        <div class="cart__img">
                            <a href="product.php?id=<?=$cartItem['product_id']?>"><img src="images/products/<?=$good['img']?>" alt="product"></a>
                        </div>
                        <a href="product.php?id=<?=$cartItem['product_id']?>" class="cart__name"><?=$good['title']?></a>
                    </div>
