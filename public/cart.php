            ...
            <div class="cart__items">
                ...
                <div class="cart__item">
                    <div class="cart__body">
                        <div class="cart__img">
                            <a href="product.php?id=<?=$cartItem['product_id']?>"><img src="images/products/1.jpg" alt="product"></a>
                        </div>
                        <a href="product.php?id=<?=$cartItem['product_id']?>" class="cart__name">product.php?id=<?=$cartItem['product_id']?></a>
                    </div>
                    <p class="cart__price">&#8381;2344.00</p>
                    <div class="cart__quant">
                        <input type="number" min="1" step="1" value="<?=$cartItem['quantity']?>">
                    </div>
